...
<CollapserGroup>
  ...
  >
    ...
    4. Optional steps:
     ...
     5. Note:
       * There’s a retry mechanism that is triggered a few times with exponential backoff for a few minutes once an error occurs - if we reach the retry limit, the Webhook will get auto- disabled.
  </Collapser>
