...
<CollapserGroup>
  ...
  >
    ...
    When you add a custom field, enter the ServiceNow field name you want to use. When you want to skip a selected field, simply use the `| skip_on_update` string at the end of the field value. This will mark it as a field that is skipped upon updates. 
