...
redirects:
  - /docs/integrations/mlops-integrations/datarobot-mlops-integration
---
...
Send your model performance metrics from Datarobot to New Relic and you'll have real-time monitoring for your algorithms. You'll explore your metrics data with user-friendly charts and learn the state of your algorithms at a glance for faster and more efficient troubleshooting. 

## Integrate Datarobot with New Relic [#integrate-datarobot] 
...
3. **Configure Datarobot for New Relic:** Use [Datarobot's docs](https://algorithmia.com/developers/algorithmia-enterprise/algorithmia-insights) for how to configure Datarobot to New Relic.
